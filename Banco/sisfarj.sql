...
insert into usuario (nome,matricula,senha,permissao_id) values ('Diretor Padrão','diretor@sisfarj.com','123456',1);
...
insert into usuario (nome,matricula,senha,permissao_id) values ('Secretario Padrão','secretario@sisfarj.com','123456',3);
...
insert into classe_atleta (nome) values ('SÃªnior');
...
insert into associacao(nome,sigla,endereco,telefone,numero_comprovante_pag,tecnico_id) values (
	'Fundacao de Natacao de SÃ£o Paulo',
	'FNSP',
	'Rua de Sampa, 18',
	'21998744578',
	'66666666',
