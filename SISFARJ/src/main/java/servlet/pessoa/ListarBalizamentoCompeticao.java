 ...
 * Edited by João V. Araújo on 15/07/18.
 */
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(id == 0){
            ...
            try {
                ...
                ArrayList<ResultadoProva> rp = ResultadoProva.findAllBy8(competicao_id, prova_id);
                ...
                getServletContext().getRequestDispatcher("/listar_provas_balizamento.jsp").forward(req, resp);
